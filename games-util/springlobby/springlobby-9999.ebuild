...
EGIT_REPO_URI="git://springlobby.info/git/buildbot/springlobby.git"

inherit cmake-utils eutils flag-o-matic games git
...
src_configure() {
	...
	if ! use libnotify ; then
		mycmakeargs="${mycmakeargs} -DOPTION_NOTIFY=OFF"
	fi
